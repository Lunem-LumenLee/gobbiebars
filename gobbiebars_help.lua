...
function M.draw_help(imgui)
    ...
    if imgui.CollapsingHeader('Commands##gb_help_commands') then
        ...
        imgui.Bullet()
        imgui.SameLine()
        imgui.TextWrapped("/gobbiebars layout  - enter or exit layout mode to adjust positions.")
    ...
    if imgui.CollapsingHeader('Layout & Bar Areas##gb_help_layout') then
        ...
        imgui.Bullet()
        imgui.SameLine()
        imgui.TextWrapped("Use /gobbiebars layout to enter layout mode.")

        imgui.Bullet()
        imgui.SameLine()
        imgui.TextWrapped("Bars and buttons can be positioned visually while layout mode is active.")
    ...
    if imgui.CollapsingHeader('Buttons##gb_help_buttons') then
        ...
        imgui.Bullet()
        imgui.SameLine()
        imgui.TextWrapped("Precise positioning with X/Y values or drag-and-drop while /gobbiebars layout is active.")
    ...
    if imgui.CollapsingHeader('Troubleshooting & FAQ##gb_help_troubleshooting') then
        ...
        imgui.Bullet()
        imgui.SameLine()
        imgui.TextWrapped("If buttons are misplaced, use /gobbiebars layout to see and adjust positions.")
        imgui.Bullet()
        imgui.SameLine()
